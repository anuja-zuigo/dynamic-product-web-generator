...
<head>
  ...
  <title>Register - ProductGen</title>
...
<body>
  ...
  <div class="auth-card">
    <div class="brand-header">
      ...
      <p class="brand-tagline">Create an account to start managing products</p>
    </div>
    ...
    registerForm.addEventListener('submit', async (e) => {
      ...
      try {
        ...
        if (response.ok && data.success) {
          ...
          alertBox.innerText = data.message || (data.errors ? data.errors.map(e => e.msg).join(', ') : 'Registration failed.');
